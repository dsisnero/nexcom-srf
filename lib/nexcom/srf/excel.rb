...
module Nexcom
  class ExcelSrf
    ...
    def close(if_unsaved: :accept)
      if @wb
        @wb.for_this_workbook(if_unsaved:)
        @wb.close
      end
    end
    ...
    def material_atts
      [
        ...
        receiver_vhf_qty,
        transmitter_vhf_qty,
        transmitter_vhf_high_qty,
        receiver_uhf_qty,
        transmitter_uhf_qty,
        transmitter_uhf_high_qty,
        # ANTENNAS
        antenna_vhf_qty,
        antenna_vhf_vhf_qty,
        antenna_uhf_qty,
        ...
        cable_other_type_ft,
        # Connectors
        conn_7_8_male_straight,
        conn_7_8_female_straight,
        conn_7_8_female_n_type,
        conn_7_8_male_andrews,
        conn_1_2_male_straight,
        conn_1_2_female_right_angle,
        conn_1_2_female_straight,
        conn_lmr_400uf_straight,
        conn_lmr_400uf_right_angle,
        conn_lmr_400uf_female_straight,
        # Racks
        rack_rcag_v2_8d_qty,
        rack_rco_v2_8d_qty,
        rack_8rx_mc_v2_83_qty,
        rack_8rx_no_mc_v2_8d_qty,
        rack_16rx_mc_v2_8d_qty,
        rack_16rx_no_mc_v2_8d_qty,
        rack_rt_shared_ant_v2_8d_qty,
        rack_rt_single_ant_v2_8d_qty,
        rack_4rtr_4_rce_v2_8d_qty,
        rack_4rtr_v2_8d_qty,
        rack_6rtr_v2_8d_qty,
        rack_buec_v2_8d_qty,
        rack_bare_83x25,
        ...
        rce_control_qty,
        rce_remote_qty,
        rce_control_cable_qty,
        rce_remote_cable_qty,
        # Site kit
        v2_site_kit
      ]
    end
    ...
    def keys_to_update
      @keys_to_update ||= att_locations.keys
    end

    def merge_default_attributes(atts)
    ...
    def update_attributes(atts)
      atts = merge_default_attributes(atts)
    ...
    def serialize(name = nil, l_serializer: nil)
      ...
      File.write(name, l_serializer.serialize(atts))
    end
    ...
    def save_as(file)
      @wb.save_as("#{file}", if_exists: :overwrite)
    end
